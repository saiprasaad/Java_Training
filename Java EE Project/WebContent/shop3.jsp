...
<body>
    ...
    <div class="row">
        <div class="col-md-12 cart">
            ...
            <div class="row border-top border-bottom">
                <div class="row main align-items-center">
                    ...
                    <div class="col"><h6 class="font-weight-bolder">Item Name</h6></div>
            ...
            <div class="row">
                <div class="row main align-items-center">
                    ...
                    <div class="col">${item.getItemdescription()}</div>
		...
		<input type="submit" value="Generate Invoice" class="btn btn-outline-dark rounded-pill"></div>
        </div>
    </div>
</div>
