...
//		pilotShoiab.doFly();
		StanleyAlopathyMCAndJetAcademy doctorandpilotobj=new StanleyAlopathyMCAndJetAcademy();
		shoiab=Proxy.newProxyInstance(Human.class.getClassLoader(), new Class[] {DoctorAndPilot.class},new MyInvocationHandler(doctorandpilotobj));
		DoctorAndPilot doctorandpilotShoiab=(DoctorAndPilot)shoiab;
		doctorandpilotShoiab.doFly();
		doctorandpilotShoiab.doCure();
...
interface DoctorAndPilot{
	public void doFly();
	public void doCure();
}
class StanleyAlopathyMCAndJetAcademy implements DoctorAndPilot{
